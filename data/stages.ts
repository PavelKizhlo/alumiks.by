...
const STAGES: Stage[] = [
  ...
  },
  {
    ...
    description:
      'Обобщение и формализация данных о проекте(память переводов, график работы, требования заказчика, глоссарий, исходные файлы, а также вся необходимая для выполнения информация).',
  },
  {
    id: 6,
