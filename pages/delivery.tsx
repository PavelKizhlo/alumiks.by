      ...
      <div className="page-wrapper">
        ...
        <div className="flex w-full flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              Безналичный расчет путем перечисления денежных средств на р/с Поставщика.
            </p>
            <p className="text-xs">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <p>
                ...
                (количество, размер, цвет и т.д.), в связи с чем указанный товар возврату
                и обмену не подлежит согласно Перечню непродовольственных товаров
                надлежащего качества, не подлежащих возврату, утвержденному Постановлением
                Совета Министров Республики Беларусь от 14.06.2002 N 778 «О мерах по
                реализации Закона Республики Беларусь «О защите прав потребителей» .
              </p>
              <p>
        ...
        <div className="flex w-full flex-col gap-6">
          ...
          <ul className="flex flex-col gap-2">
            <li> - Самовывоз;</li>
            <li>
              - Доставка на объект Заказчика транспортной компанией (оплата согласно
              тарифам ТК);
            </li>
