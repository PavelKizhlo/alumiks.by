...
function HeadingBlock() {
  return (
    <article className="bg-headingBlockBG bg-contain bg-no-repeat h-fit relative">
      <Image src={bgImg} alt="background" />
      <div className="absolute h-full w-full top-0 flex flex-col justify-between items-center px-32 pt-32 pb-12">
