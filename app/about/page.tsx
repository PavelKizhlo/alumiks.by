          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <ul className="grid grid-cols-1 items-center justify-center gap-2 md:grid-cols-3 xs:grid-cols-2">
              <li className="flex gap-4">
                ...
                <span className="w-fit">современное технологическое оборудование;</span>
              </li>
              <li className="flex gap-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="w-fit">квалифицированный персонал;</span>
              </li>
              <li className="flex gap-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="w-fit">
                  высокое качество изделий (100- процентный контроль);
                </span>
              </li>
              <li className="flex gap-4">
                <svg
                ...
                <span className="w-fit">краткие сроки изготовления;</span>
              </li>
              <li className="flex gap-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="w-fit">разумные цены;</span>
              </li>
              <li className="flex gap-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="w-fit">индивидуальный подход к заказчику;</span>
              </li>
              <li className="flex gap-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="w-fit">удобное месторасположение.</span>
              </li>
            </ul>
          </div>
          <div className="flex flex-col items-center gap-8">
            ...
            <ul className="grid grid-cols-1 items-center justify-center gap-2 xs:grid-cols-2">
              ...
              <li className="flex gap-4">
                ...
                <span className="w-fit">
                  изготовление оконных отливов из оцинкованной стали с полимерным
                  покрытием и без;
                </span>
              </li>
              <li className="flex gap-4">
                ...
                <span className="w-fit">
                  производство евроштакетника и заборов-жалюзи;
                </span>
              </li>
              <li className="flex gap-4">
                <svg
                ...
                <div className="flex w-full flex-col items-center gap-6">
                  ...
                  <ul className="flex flex-col gap-2">
                    <li className="flex gap-4">
                      ...
                      <span>противомоскитные сетки на окна ПВХ;</span>
                    </li>
                    <li className="flex gap-4">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span>противомоскитные сетки на алюминиевые балконные рамы;</span>
                    </li>
                    <li className="flex gap-4">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span>противомоскитные сетки на балконные и входные двери;</span>
                    </li>
                    <li className="flex gap-4">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span>парочные и трапециевидные сетки.</span>
                    </li>
                  </ul>
                </div>
              </li>
                ...
                <div className="flex flex-col items-center gap-6">
                  ...
                  <ul className="flex flex-col gap-2">
                    <li className="flex gap-4">
                      ...
                      <span>подоконники ПВХ бюджетные и премиум-класса;</span>
                    </li>
                    <li className="flex gap-4">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span>сэндвич-панели для откосов и комплектующие к ним.</span>
                    </li>
                  </ul>
                </div>
              </li>
